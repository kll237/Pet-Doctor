  ...
  return (
    <div className="px-4 pt-2 pb-28 bg-cream-50 min-h-full">
      ...
      <motion.button
        ...
        className="absolute right-4 bottom-[112px] z-40 h-16 w-16 rounded-full bg-gradient-to-br from-brand-500 to-brand-700 text-white grid place-items-center shadow-[0_10px_30px_-6px_rgba(176,102,14,0.55)] ring-[5px] ring-white/95 active:scale-95 transition-transform"
        aria-label="发布帖子"
      >
